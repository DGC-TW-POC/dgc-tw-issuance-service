...
function getHtmlTemplate(vaccineData, tan) {
    ...
    * {
    ...
    <table style="font-family:georgia,palatino;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      <tbody>
        <tr>
          <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:georgia,palatino;" align="left">
          親愛的${vaccineData.person.Name}您好：
          您於${moment().format("YYYY年-MM月-DD日")}(身分證號/居留證號/護照號碼：${vaccineData.IdNo.substr(0,6)}****)產生疫苗護照QRCode
          以下為您的驗證(TAN)碼:
          </td>
        </tr>
      </tbody>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td style="padding-right: 0px;padding-left: 0px;" align="center">
          ...
          <img align="center" border="0" src="https://i.imgur.com/Av94ojd.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 600px;" width="600"/>
    ...
    <table style="font-family:georgia,palatino;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="color: #3d3030; line-height: 140%; text-align: center; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;"><span style="line-height: 22.4px; font-size: 16px;">您的驗證碼</span></span></p>
      </div>
    ...
    <table style="font-family:georgia,palatino;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="color: #236fa1; line-height: 130%; text-align: center; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 130%;"><span style="font-size: 72px; line-height: 93.6px;"><span style="line-height: 93.6px; font-size: 72px;"></span>${tan}</span></p>
      </div>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td style="padding-right: 0px;padding-left: 0px;" align="center">
          ...
          <img align="center" border="0" src="cid:image1" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 600px;" width="600"/>
...
async function sendTANEmail (vaccineData, tan) {
    try {
        let info = await transporter.sendMail({
            from: config.mail.auth.user, // sender address
            to: vaccineData.email, // list of receivers
            subject: "疫苗護照QRCode產生之驗證碼通知", // Subject line
            //text: ``, // plain text body
            html: getHtmlTemplate(vaccineData, tan), // html body
            attachments: [
              {
